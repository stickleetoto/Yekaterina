...
1. Download the official `Yekaterina_v1.2.0_windows-x64.zip` release asset from GitHub Releases.
...
For the full v1.2.0 promotion evidence, see [Verification](VERIFICATION.md) and the [v1.2.0 release notes](../releases/v1.2.0/RELEASE_NOTES.md).
